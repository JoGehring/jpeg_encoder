...
mod tests {
    ...
    fn test_inverse_dct_from_slides() {
        ...
        let x_vec = vec![
            ...
            22.0, 39.0, 53.0, 59.0, 63.0, 50.0, 48.0, 25.0, 37.0, 87.0, 31.0, 27.0, 33.0, 27.0, 37.0, 50.0, 81.0, 148.0, 54.0, 31.0, 33.0,
            46.0, 58.0, 104.0, 144.0, 179.0, 76.0, 70.0, 71.0, 91.0, 118.0, 151.0, 176.0, 184.0, 102.0, 105.0, 115.0, 124.0, 135.0,
            168.0, 173.0, 181.0,
        ];
